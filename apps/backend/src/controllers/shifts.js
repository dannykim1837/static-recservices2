/*
==============================================
  ✅ SHIFTS CONTROLLER (Supabase version)
  - Handles API requests for shift management
...
// Set the table name to match Supabase exactly. If your table is 'Shift', use that. If you want to standardize, use 'shifts'.
const dbName = "shifts"; // Change to 'Shift' if your Supabase table is named that
